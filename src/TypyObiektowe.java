// przechowują aktualną wartośc oraz umożliwiaja wykonanie akcji (wywołanie metod) na tych danych
public class TypyObiektowe {
    ...
    Float fifthNumber = 4.99934F; // 4 bajty - max ok 6-7 liczba po przecinku
